        ...
        <>
            <section className="w-full h-full hidden sm:flex gap-6 p-6">
                <div className="w-3/5 h-full">
                    <div className="w-full h-full rounded-3xl bg-white dark:bg-[#1E293B] border border-[#E2E8F0] dark:border-[#334155] p-10 shadow-lg flex flex-col justify-between gap-6 overflow-auto">
            ...
            {/* Mobile Section */}
            <section className="w-full h-full sm:hidden flex flex-col p-4 gap-4 overflow-auto">
                <div className="w-full aspect-square rounded-3xl overflow-hidden bg-gradient-to-br from-[#3B82F6]/10 to-[#8B5CF6]/10 dark:from-[#60A5FA]/10 dark:to-[#A78BFA]/10 relative">
                    <Image
                        src={KunalImage}
                        alt="Kunal Bera Avatar"
                        fill
                ...
                <div className="w-full rounded-3xl bg-white dark:bg-[#1E293B] border border-[#E2E8F0] dark:border-[#334155] p-6 shadow-lg flex flex-col gap-6">
                    <div className="w-full flex flex-col gap-4">
                        ...
                        <p className="text-[0.625rem] leading-[1.5] font-medium text-[#475569] dark:text-[#CBD5E1]">
                            I create high-performance, visually engaging applications using Next.js, React, and Angular — turning complex ideas into fast, user-friendly products.
                        </p>
                    </div>
